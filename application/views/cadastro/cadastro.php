...
<html>
	...
	<body>
		...
		<div class="alert alert-success">
		  <strong>Successo!</strong> Produto cadastrado com sucesso.
		</div>
		<?php endif ?>
		...
		<div class="cadastro-area">
			<div class="cadastro">
				...
				<form method="POST" action="produto/cadastrar" data-toggle="validator" enctype="multipart/form-data">
					<input type="text" name="nome" placeholder="Nome do produto" class="col-7 form-control" required><br>
					
					<input type="number" step="0.01" name="preco" placeholder="Digite o preço do produto" class="col-7 form-control" required><br>
					
					<input type="text" name="especificacao" placeholder="Digite as especificações dos produto" class="col-7 form-control" required><br>
					
					<textarea type="text-area" name="descricao" placeholder="Descrição do produto" class="col-7 form-control" required></textarea><br>
